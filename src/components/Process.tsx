...
export default function Process({ containerRef: scrollContainerRef }: { containerRef: React.RefObject<HTMLDivElement> }) {
  ...
  return (
    <section id="proceso" ref={containerRef} className="min-h-[100dvh] md:h-screen w-full relative px-[24px] md:px-[96px] py-[80px] md:py-0 bg-dark overflow-hidden flex items-center">
