...
export const PROJECTS: Project[] = [
  {
    ...
    year: '2024',
    area: '185 m²',
    images: ['/sitio original/assets/project-1.jpg', '/sitio original/assets/project-1.jpg', '/sitio original/assets/project-1.jpg'],
    featured: true,
    technicalDetails: {
    ...
    process: {
      ...
      final: '/sitio original/assets/project-1.jpg',
  ...
  },
  {
    ...
    year: '2024',
    area: '420 m²',
    images: ['/sitio original/assets/project-2.jpg', '/sitio original/assets/project-2.jpg'],
    process: {
      sketch: 'https://picsum.photos/seed/sketch2/1920/1080?grayscale',
      final: '/sitio original/assets/project-2.jpg',
  ...
  },
  {
    ...
    year: '2023',
    area: '1.200 m²',
    images: ['/sitio original/assets/project-3.jpg', '/sitio original/assets/project-3.jpg'],
    technicalDetails: {
    ...
    process: {
      ...
      final: '/sitio original/assets/project-3.jpg',
  ...
  },
  {
    ...
    year: '2023',
    area: '310 m²',
    images: ['/sitio original/assets/project-4.jpg', '/sitio original/assets/project-4.jpg'],
    technicalDetails: {
